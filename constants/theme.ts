...
export const THEME_METADATA: Record<ThemeId, ThemeMeta> = {
  "catppuccin-latte": {
    ...
    isDark: false,
    category: "light",
    previewColors: ["#eff1f5", "#8839ef", "#209fb5"],
  },
  "catppuccin-mocha": {
    id: "catppuccin-mocha",
    ...
    isDark: true,
    category: "dark",
    previewColors: ["#0f0f17", "#cba6f7", "#74c7ec"],
  },
  amoled: {
    id: "amoled",
    name: "AMOLED Black",
...
export const CatppuccinLatteColors: ThemeColors = {
  ...
  secondaryContainer: "#e0f2f7",
  onSecondary: "#ffffff",
  onSecondaryContainer: Latte.sapphire,
  tertiary: Latte.teal,
  ...
  cardRequest: "#e8f4f8",
  cardRequestBorder: Latte.sapphire,
