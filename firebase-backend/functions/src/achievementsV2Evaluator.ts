...
const SCORE_LIMITS: Record<string, GameScoreLimits> = {
  ...
  brick_breaker: { minScore: 0, maxScore: 896, scoreDirection: "higher" },
  minesweeper_classic: { minScore: 1, maxScore: 9999, scoreDirection: "lower" },
  pong_game: { minScore: 0, maxScore: 7, scoreDirection: "higher" },
  ...
  battleship: { minScore: 0, maxScore: 9999, scoreDirection: "higher" },
};
...
function buildCatalog(): AchievementDef[] {
  ...
  // ── Brick Breaker — Atari Breakout achievements ────────────────────
  catalog.push(
    {
      id: "achv.game.brick_breaker.first_play",
      name: "Brick Layer",
      description: "Play Bricks for the first time",
      icon: "🧱",
      category: "single_player",
      tier: "bronze",
    ...
    {
      id: "achv.game.brick_breaker.wall_1",
      name: "Wall Breaker",
      description: "Clear the first wall of bricks",
      icon: "🧱",
      category: "single_player",
      tier: "bronze",
      gameType: "brick_breaker",
      progressType: "stat_threshold",
      statKey: "wallsCleared",
      target: 1,
      xpReward: 25,
      coinReward: 15,
      rewards: { tokens: 15 },
      isEnabledByDefault: true,
      version: 3,
      group: "achv.game.brick_breaker.walls",
    },
    {
      id: "achv.game.brick_breaker.wall_2",
      name: "Double Break",
      description: "Clear both walls in a single game",
      icon: "🧱",
      category: "single_player",
      tier: "gold",
      gameType: "brick_breaker",
    ...
    {
      id: "achv.game.brick_breaker.score_200",
      name: "Brick Crusher",
    ...
    {
      id: "achv.game.brick_breaker.score_max",
      name: "Perfect Clear",
      description: "???",
      icon: "💎",
      category: "single_player",
    ...
    {
      id: "achv.game.brick_breaker.speed_tier_4",
      name: "Supersonic",
      description: "Reach the maximum ball speed tier",
      icon: "⚡",
      category: "single_player",
      tier: "silver",
      gameType: "brick_breaker",
      progressType: "stat_threshold",
      statKey: "maxSpeedTier",
      target: 4,
      xpReward: 50,
      coinReward: 25,
      rewards: { tokens: 25 },
    ...
    },
    {
      ...
      description: "Play 10 games of Bricks",
      icon: "🧱",
      category: "single_player",
      tier: "silver",
      gameType: "brick_breaker",
    ...
    {
      id: "achv.game.brick_breaker.no_lives_lost",
      name: "Untouchable",
      description: "Finish a game without losing any lives",
      icon: "🛡️",
      category: "single_player",
      tier: "platinum",
      gameType: "brick_breaker",
      progressType: "stat_threshold",
      statKey: "livesRemaining",
      target: 3,
      xpReward: 250,
      coinReward: 100,
  ...
  // NOTE: pong_game removed — now multiplayer with max score 7, so
  // pct_of_max thresholds (250/500/750/899) are unreachable.
  // Pong MP achievements are defined separately below.
  const otherSpGames = [
  ...
  // ── Pong multiplayer achievements ─────────────────────────────────
  catalog.push(
    {
      id: "achv.rt.pong_game.first_match",
      name: "Paddle Pusher",
      description: "Play your first online Pong match",
      icon: "🏓",
      category: "real_time",
      tier: "bronze",
      gameType: "pong_game",
    ...
    {
      id: "achv.rt.pong_game.first_win",
      name: "Ace!",
    ...
    {
      id: "achv.rt.pong_game.wins_10",
      name: "Pong Pro",
      description: "Win 10 online Pong matches",
      icon: "⭐",
      category: "real_time",
      tier: "silver",
      gameType: "pong_game",
    ...
    {
      id: "achv.rt.pong_game.matches_25",
      name: "Table Tennis Enthusiast",
    ...
    {
      id: "achv.rt.pong_game.shutout",
      name: "Shutout!",
      description: "Win an online Pong match 7-0",
      icon: "🚫",
      category: "real_time",
      tier: "gold",
      gameType: "pong_game",
  ...
  // ── Battleship multiplayer achievements ───────────────────────────
  catalog.push(
    {
      id: "achv.rt.battleship.first_match",
      name: "Anchors Aweigh",
      description: "Play your first Battleship match",
      icon: "⚓",
      category: "real_time",
      tier: "bronze",
      gameType: "battleship",
    ...
    {
      id: "achv.rt.battleship.first_win",
      name: "Victorious Admiral",
      description: "Win your first Battleship match",
      icon: "🏆",
      category: "real_time",
      tier: "bronze",
      gameType: "battleship",
    ...
    {
      id: "achv.rt.battleship.wins_10",
      name: "Fleet Commander",
      description: "Win 10 Battleship matches",
      icon: "⭐",
      category: "real_time",
      tier: "silver",
      gameType: "battleship",
    ...
    {
      id: "achv.rt.battleship.matches_25",
      name: "Sea Veteran",
      description: "Play 25 Battleship matches",
      icon: "🎮",
      category: "real_time",
      tier: "gold",
      gameType: "battleship",
    ...
    {
      id: "achv.rt.battleship.flawless_victory",
      name: "Unsinkable",
    ...
    {
      id: "achv.rt.battleship.sharpshooter",
      name: "Sharpshooter",
      description: "Win a match with 70% or better accuracy",
      icon: "🎯",
      category: "real_time",
      tier: "silver",
      gameType: "battleship",
      progressType: "stat_threshold",
      statKey: "sharpshooterWin",
      target: 1,
      xpReward: 75,
      coinReward: 35,
      rewards: { tokens: 35 },
    ...
    {
      id: "achv.rt.battleship.comeback",
      name: "Against the Tide",
      description: "Win after losing 4 of your 5 ships",
      icon: "🔥",
      category: "real_time",
      tier: "gold",
      gameType: "battleship",
    ...
    {
      id: "achv.rt.battleship.perfect_game",
      name: "Perfect Storm",
      description: "Win a match without missing a single shot",
      icon: "💎",
      category: "real_time",
      tier: "platinum",
      gameType: "battleship",
      ...
      rewards: {
        tokens: 100,
        entitlements: ["badge_battleship_perfectionist"],
      },
      isEnabledByDefault: true,
      secret: true,
      version: 1,
    ...
    {
      id: "achv.rt.battleship.speedrun",
      name: "Blitz Attack",
      description: "Win a match in 25 or fewer shots",
      icon: "⚡",
      category: "real_time",
      tier: "platinum",
      gameType: "battleship",
      ...
      xpReward: 200,
      coinReward: 100,
      rewards: { tokens: 100, entitlements: ["badge_battleship_speedrunner"] },
      isEnabledByDefault: true,
      secret: true,
      version: 1,
    },
  ...
  catalog.push(
    {
      id: "achv.game.bounce_blitz.level_5",
      name: "First Strike",
      description: "Reach level 5 in Bounce Blitz",
      icon: "⚪",
      category: "single_player",
      tier: "bronze",
    ...
    {
      id: "achv.game.bounce_blitz.level_50",
      name: "Marathon Runner",
      description: "Reach level 50 in Bounce Blitz",
      icon: "🏃",
      category: "single_player",
      tier: "platinum",
      gameType: "bounce_blitz",
      ...
      xpReward: 200,
      coinReward: 100,
      rewards: { tokens: 100, entitlements: ["badge_bounce_platinum"] },
      isEnabledByDefault: true,
      version: 2,
      group: "achv.game.bounce_blitz.levels",
    },
    {
      id: "achv.game.bounce_blitz.level_100",
      name: "Century",
      description: "Reach level 100 in Bounce Blitz",
      icon: "💯",
      category: "single_player",
      tier: "diamond",
      gameType: "bounce_blitz",
      ...
      xpReward: 500,
      coinReward: 250,
      rewards: { tokens: 250, entitlements: ["badge_bounce_century"] },
      isEnabledByDefault: true,
      version: 2,
      group: "achv.game.bounce_blitz.levels",
    },
    {
      id: "achv.game.bounce_blitz.blocks_100",
      name: "Brick Buster",
      description: "Destroy 100 blocks in a single game",
      icon: "🧱",
      category: "single_player",
      tier: "silver",
      gameType: "bounce_blitz",
      ...
      isEnabledByDefault: true,
      version: 2,
      group: "achv.game.bounce_blitz.blocks",
    },
    {
      id: "achv.game.bounce_blitz.blocks_500",
      name: "Block Buster",
      description: "Destroy 500 blocks in a single game",
      icon: "💥",
      category: "single_player",
      tier: "gold",
      gameType: "bounce_blitz",
    ...
    {
      id: "achv.game.bounce_blitz.blocks_2000",
      name: "Demolition King",
      description: "Destroy 2,000 blocks in a single game",
      icon: "🏗️",
      category: "single_player",
      tier: "platinum",
      gameType: "bounce_blitz",
      ...
      xpReward: 200,
      coinReward: 100,
      rewards: { tokens: 100, entitlements: ["badge_bounce_demolition"] },
      isEnabledByDefault: true,
      version: 2,
      group: "achv.game.bounce_blitz.blocks",
    },
    {
      id: "achv.game.bounce_blitz.balls_20",
      name: "Ball Hoarder",
      description: "Have 20 or more balls at once",
      icon: "🔮",
      category: "single_player",
      tier: "gold",
      gameType: "bounce_blitz",
      progressType: "stat_threshold",
      statKey: "peakBallCount",
      target: 20,
      xpReward: 75,
      coinReward: 40,
      rewards: { tokens: 40 },
    ...
    {
      id: "achv.game.bounce_blitz.bounces_1000",
      name: "Ricochet Master",
      description: "Rack up 1,000 bounces in a single game",
      icon: "🏓",
      category: "single_player",
      tier: "gold",
      gameType: "bounce_blitz",
      progressType: "stat_threshold",
      statKey: "totalBounces",
      target: 1000,
      xpReward: 100,
      coinReward: 50,
      rewards: { tokens: 50 },
