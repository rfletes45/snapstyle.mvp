...
export interface GameAdapterV4 {
     ...
     */
    applyOfflineProgression?(publicState: Record<string, unknown>, elapsedMs: number, context: {
        uid: string;
        settings: Record<string, unknown>;
    }): {
        nextPublicState: Record<string, unknown>;
    ...
    getPersistentSoloSummary?(publicState: Record<string, unknown>): Record<string, unknown>;
     ...
     */
    archiveRun?(publicState: Record<string, unknown>, context: {
        uid: string;
        settings: Record<string, unknown>;
    }): {
        finalScoreboard: Array<{
