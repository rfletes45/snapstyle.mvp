  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.header}>
        ...
        <Text style={[styles.title, { color: colors.text }]}>🏓 Snap Pong</Text>
        <View style={{ width: 40 }} />
      </View>
      ...
      {(gameState === "playing" || gameState === "paused") && (
        <View style={styles.courtContainer}>
          ...
          >
            {/* Center line */}
            <View style={[styles.centerLine, { borderColor: colors.border }]} />
            ...
            {powerUp.current?.active && (
              <View
                style={[
                  styles.powerUp,
                  {
                    left: powerUp.current.x - 12,
                    top: powerUp.current.y - 12,
                    backgroundColor:
