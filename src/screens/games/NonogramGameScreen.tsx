  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.header}>
        ...
        <Text style={[styles.title, { color: colors.text }]}>🧩 Nonogram</Text>
        {gameState === "playing" && (
              ...
              <View key={r} style={styles.gridRow}>
                ...
                {row.map((cell, c) => (
                  <TouchableOpacity
                    ...
                    activeOpacity={0.6}
                  >
                    <Canvas style={{ width: CELL_SIZE - 2, height: CELL_SIZE - 2 }}>
                      <RoundedRect x={0} y={0} width={CELL_SIZE - 2} height={CELL_SIZE - 2} r={2}>
                        ...
                        />
                        <Shadow dx={0} dy={1} blur={2} color={cell === "filled" ? "rgba(0,0,0,0.3)" : "rgba(0,0,0,0.1)"} inner />
                      </RoundedRect>
                      {cell === "filled" && (
                        <RoundedRect x={1} y={1} width={CELL_SIZE - 4} height={3} r={1}>
                          <LinearGradient
                            start={vec(0, 1)}
                            end={vec(0, 4)}
