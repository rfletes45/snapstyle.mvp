        ...
        <Canvas style={StyleSheet.absoluteFill}>
          ...
          <RoundedRect x={0} y={0} width={sz} height={sz} r={r}>
            <LinearGradient
              ...
              colors={
                isOn
                  ? ["#FFE44D", "#FFD600", "#E6B800"]
                  : ["#3A3A3E", "#2A2A2E", "#222226"]
              }
            />
            <Shadow
              dx={0}
              dy={1}
              blur={2}
              color={isOn ? "rgba(0,0,0,0.1)" : "rgba(0,0,0,0.3)"}
              inner
            />
          </RoundedRect>
          ...
          {/* Top highlight strip */}
          <RoundedRect x={2} y={2} width={sz - 4} height={sz * 0.35} r={r - 1}>
            <LinearGradient
              start={vec(0, 0)}
              end={vec(0, sz * 0.35)}
              colors={[
                isOn ? "rgba(255,255,255,0.35)" : "rgba(255,255,255,0.08)",
                "rgba(255,255,255,0)",
              ]}
            />
          </RoundedRect>
