  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={styles.header}>
        ...
        <Text style={[styles.title, { color: colors.text }]}>Snap Four</Text>
        <View style={{ width: 32 }} />
      </View>
      ...
      {gameState === "menu" ? (
        ...
        <>
          ...
          {/* Board - columns are full-height tappable */}
          <View style={styles.boardContainer}>
            <View
              style={[styles.board, { backgroundColor: colors.primary + "20" }]}
            >
...
const styles = StyleSheet.create({
  ...
  board: { borderRadius: 12, padding: 4 },
