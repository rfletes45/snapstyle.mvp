                ...
                >
                  <View
                    style={[
                      styles.targetInner,
                      {
                        width: target.maxRadius,
                        height: target.maxRadius,
                        borderRadius: target.maxRadius / 2,
                  ...
                  <View
                    style={[
                      styles.targetCenter,
                      {
                        width: target.maxRadius * 0.4,
                        height: target.maxRadius * 0.4,
                        borderRadius: target.maxRadius * 0.2,
