...
export const COSMETICS_CATALOG: CosmeticDefinition[] = [
  ...
  },
  {
    ...
    type: "badge",
    name: "Golf Ace",
    description: "Score a hole-in-one in MiniGolf Duels",
    rarity: "rare",
    source: "achievement",
    achievementId: "achv.rt.minigolf_duels.hole_in_one",
    tags: ["games", "minigolf"],
    sortOrder: 19,
  },
  {
    id: "badge_golf_master",
    type: "badge",
    name: "Golf Master",
    description: "Score 5 holes-in-one in MiniGolf Duels",
    rarity: "epic",
    source: "achievement",
    achievementId: "achv.rt.minigolf_duels.holes_in_one_5",
    tags: ["games", "minigolf"],
    sortOrder: 20,
  },
