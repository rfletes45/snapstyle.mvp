...
// =============================================================================
// Brick Breaker Achievements — Atari Breakout Milestones
// =============================================================================
...
const BRICK_BREAKER_ACHIEVEMENTS: AchievementDef[] = [
  ...
  },
  {
    ...
    name: "Double Demolition",
    description: "Clear both walls and win the game",
    icon: "🧱",
    category: "single_player",
    tier: "gold",
    gameType: "brick_breaker",
  ...
  },
  {
    ...
    isEnabledByDefault: true,
    version: 3,
    group: "achv.game.brick_breaker.score",
    sortOrder: 113,
  },
  {
    id: "achv.game.brick_breaker.score_max",
    name: "Perfect Score",
    description: "Achieve the maximum score of 896 (both walls cleared)",
    icon: "💎",
    category: "single_player",
    tier: "diamond",
    gameType: "brick_breaker",
  ...
  },
  {
    ...
    name: "Speed Demon",
    description: "Reach the maximum speed tier (red contact)",
    icon: "🔴",
    category: "single_player",
    tier: "silver",
    gameType: "brick_breaker",
  ...
  },
  {
    ...
    name: "Unbreakable",
    description: "Win the game without losing any lives",
    icon: "🛡️",
    category: "single_player",
    tier: "platinum",
    gameType: "brick_breaker",
...
const TB_GAMES: Array<{
  ...
  { gameType: "crazy_eights", name: "Crazy Cards", icon: "🃏" },
...
function buildRealTimeAchievements(): AchievementDef[] {
  ...
  result.push({
    ...
    xpReward: 200,
    coinReward: 100,
    rewards: { tokens: 100, entitlements: ["badge_battleship_perfectionist"] },
    isEnabledByDefault: true,
    secret: true,
    version: 1,
    sortOrder: sortOrder++,
