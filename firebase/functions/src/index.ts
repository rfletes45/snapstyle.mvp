...
async function updateStreakOnMessage(
  ...
  try {
    ...
    let friendDoc = querySnapshot.docs.find(
 ...
 */
export const claimTaskReward = functions.https.onCall(
 ...
 */
export const seedDailyTasks = functions.https.onRequest(
...
export const purchaseWithTokens = functions.https.onCall(
  async (data: any, context: functions.https.CallableContext) => {
    ...
    console.log(
      `🛒 [purchaseWithTokens] User ${uid} purchasing item ${itemId}`,
    );
    ...
    try {
      ...
      if (wallet.tokensBalance < priceTokens) {
        throw new functions.https.HttpsError(
          "failed-precondition",
          `Insufficient tokens. Need ${priceTokens}, have ${wallet.tokensBalance}`,
        );
      }
      ...
      console.log(
        `✅ [purchaseWithTokens] Purchase complete: ${item.name} for ${priceTokens} tokens. New balance: ${newBalance}`,
      );
  ...
  async (req: functions.https.Request, res: functions.Response) => {
    ...
    const shopItems = [
      // Featured limited-time items
      {
        ...
        priceTokens: 150,
        rarity: "legendary",
        imagePath: "cosmetics/hats/crown.png",
        featured: true,
      ...
      },
      {
        ...
        priceTokens: 100,
        rarity: "epic",
        imagePath: "cosmetics/backgrounds/galaxy.png",
        featured: true,
        availableFrom: Date.now(),
      ...
      // Regular shop items - Hats
      {
        ...
        priceTokens: 25,
        rarity: "common",
        imagePath: "cosmetics/hats/cap.png",
        featured: false,
        purchaseCount: 0,
        active: true,
        sortOrder: 10,
      },
      {
        ...
        priceTokens: 30,
        rarity: "common",
        imagePath: "cosmetics/hats/beanie.png",
        featured: false,
        purchaseCount: 0,
        active: true,
        sortOrder: 11,
      },
      {
        ...
        priceTokens: 50,
        rarity: "rare",
        imagePath: "cosmetics/hats/tophat.png",
        featured: false,
        purchaseCount: 0,
        active: true,
        sortOrder: 12,
      ...
      // Glasses
      {
        ...
        priceTokens: 20,
        rarity: "common",
        imagePath: "cosmetics/glasses/round.png",
        featured: false,
        purchaseCount: 0,
        active: true,
        sortOrder: 20,
      },
      {
        ...
        priceTokens: 35,
        rarity: "rare",
        imagePath: "cosmetics/glasses/sunglasses.png",
        featured: false,
        purchaseCount: 0,
        active: true,
        sortOrder: 21,
      },
      {
        ...
        priceTokens: 75,
        rarity: "epic",
        imagePath: "cosmetics/glasses/vr.png",
        featured: false,
        purchaseCount: 0,
        active: true,
        sortOrder: 22,
      ...
      // Backgrounds
      {
        ...
        priceTokens: 40,
        rarity: "rare",
        imagePath: "cosmetics/backgrounds/sunset.png",
        featured: false,
        purchaseCount: 0,
        active: true,
        sortOrder: 30,
      },
      {
        ...
        priceTokens: 45,
        rarity: "rare",
        imagePath: "cosmetics/backgrounds/city.png",
        featured: false,
        purchaseCount: 0,
        active: true,
        sortOrder: 31,
      },
      {
        ...
        priceTokens: 60,
        rarity: "epic",
        imagePath: "cosmetics/backgrounds/neon.png",
        featured: false,
        purchaseCount: 0,
        active: true,
        sortOrder: 32,
